    ...
    return (
        <>
            <footer class="bg-dark text-white pt-5 pb-4">
                <div class="container">
                    <div class="row">
                        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 text-md-start">
                            <h5 class="text-uppercase mb-4 font-weight-bold">Liens</h5>
                            <p><a href="#" class="text-white text-decoration-none">Accueil</a></p>
                            <p><a href="#" class="text-white text-decoration-none">À propos</a></p>
                            <p><a href="#" class="text-white text-decoration-none">Services</a></p>
                            <p><a href="#" class="text-white text-decoration-none">Contact</a></p>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 mx-auto mt-3 text-md-center">
                            <h5 class="text-uppercase mb-4 font-weight-bold">Suivez-nous</h5>
                        ...
                        <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3 text-md-end">
                            <h5 class="text-uppercase mb-4 font-weight-bold">Contact</h5>
                            <p><i class="bi bi-house-door-fill me-2"></i>4 rue de la paix, Paris</p>
                            <p><i class="bi bi-envelope-fill me-2"></i>contact@txlforma.com</p>
                            <p><i class="bi bi-telephone-fill me-2"></i>+33 6 12 34 56 78</p>
                        </div>
                    </div>
                    <hr class="mb-4" />
