 ...
 * Composant de contenu pour la création/édition de cours
 * Permet de gérer les chapitres, médias et publication des formations
 */
function CourseContentContent() {
  ...
  const handleFilesUpload = async (e) => {
    ...
    console.log(
      "Uploading files:",
      files.map((f) => `${f.name} (${(f.size / 1024 / 1024).toFixed(2)}MB)`)
    );
    setIsLoading(true);
  ...
  return (
    <div style={{ flex: 1, display: "flex", flexDirection: "column" }}>
      ...
      <p className="text-secondary mb-4">Gérez le contenu de votre cours</p>
      ...
      <div className="d-flex gap-3 mb-5">
        <button
          ...
          style={{
            ...
            padding: "10px 30px",
            opacity:
              isLoading || !formData.title || !formData.category ? 0.6 : 1,
          }}
        >
...
export default CourseContentContent;
