...
/**
 * SessionsContent
 * Composant de contenu pour le calendrier des sessions professeur
 * Affiche les sessions en vue semaine ou mois
 */
        ...
        <>
          ...
          <div className="d-flex justify-content-between align-items-center mb-4">
            <div className="d-flex align-items-center gap-2">
              ...
              <button className="btn btn-prof" onClick={goToToday}>
                Aujourd'hui
              </button>
              <button
                className="btn btn-outline-dark"
