            ...
            <div className="container">
                ...
                <div className="row mt-4 mb-5 gx-4 gy-4">
                        ...
                        <div className="grey-border-box flex-fill">
                            <svg viewBox="0 0 24 24" width="50" height="50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3 7C3 5.11438 3 4.17157 3.58579 3.58579C4.17157 3 5.11438 3 7 3H12H17C18.8856 3 19.8284 3 20.4142 3.58579C21 4.17157 21 5.11438 21 7V10V13C21 14.8856 21 15.8284 20.4142 16.4142C19.8284 17 18.8856 17 17 17H12H7C5.11438 17 4.17157 17 3.58579 16.4142C3 15.8284 3 14.8856 3 13V10V7Z"
                                    stroke="#000000" strokeWidth="2" strokeLinejoin="round" />
                                <path d="M9 21L11.625 17.5C11.8125 17.25 12.1875 17.25 12.375 17.5L15 21"
                                    stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M12 9L12 13" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M16 7L16 13" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M8 10L8 13" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                    ...
                    <div className="col-12 col-md-4 d-flex">
                        <div className="grey-border-box flex-fill">
                            <svg viewBox="0 0 24 24" width="50" height="50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="12" cy="16" r="3" stroke="#000000" strokeWidth="1.5"></circle>
                                ...
                                <path d="M9 6L15 6" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"></path>
                                <path d="M7 9.5H9M17 9.5H12.5" stroke="#000000" strokeWidth="1.5" strokeLinecap="round"></path>
                            </svg>
