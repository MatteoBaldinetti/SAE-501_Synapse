...
function Login() {
  ...
  useEffect(() => {
    // Mesurer la hauteur du formulaire actif
      ...
      <div id="formContainer">
        <div id="formBox">
          ...
          <div ref={wrapperRef} className="form-wrapper">
            ...
            <div className={`form-content ${isConnexion ? "active" : ""}`}>
              ...
              <div className="text-end mb-3">
                <a href="#" className="text-secondary small" onClick={e => e.preventDefault()}>Mot de passe oublié ?</a>
              </div>
            </div>
            ...
            <div className={`form-content ${!isConnexion ? "active" : ""}`}>
              ...
              <p className="text-secondary small mb-0">Minimum 8 caractères, doit contenir une majuscule et un caractère spécial.</p>
            </div>
          </div>
          ...
          <div className="form-bottom d-flex flex-column align-items-center">
            ...
            <a href="#" onClick={e => { e.preventDefault(); changeForm(); }} className="text-dark text-decoration-none link-pointer">
